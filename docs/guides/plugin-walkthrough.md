...
| # | Command | Result | Time |
|---|---|---|---|
| 1 | `tellurion doctor` | PASS | 0:20 |
| 2 | `tellurion new-plugin --kind sensor --name my-buoy --dir my_buoy` | 4 files scaffolded | 0:10 |
...
| 8 | `tellurion plugins validate ./my_buoy` | PASS, qualified | 0:10 |
